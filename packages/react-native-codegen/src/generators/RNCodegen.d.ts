...
export type LibraryGeneratorFunction = (
  libraryName: string,
  schema: SchemaType,
  packageName: string | undefined,
  assumeNonnull: boolean,
) => FilesOutput;
export type SchemaGeneratorFunction = (schemas: {
  [key: string]: SchemaType;
}) => FilesOutput;
export type ViewGeneratorFunction = (
  libraryName: string,
  schema: SchemaType,
) => FilesOutput;
...
type ViewGeneratorNames = 'generateViewConfigJs';
...
export declare const libraryGenerators: {
  readonly [key in LibraryGenerators]: LibraryGeneratorFunction;
};
export declare const schemaGenerators: {
  readonly [key in SchemaGenerators]: SchemaGeneratorFunction;
};
export declare function generate(
  options: LibraryOptions,
  config: LibraryConfig,
): boolean;
export declare function generateFromSchemas(
